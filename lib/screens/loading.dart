...
class _LoadingState extends State<Loading> {
  List<bool> selected = [];
  //sharedpreference to check if selected currency exists
  ...
  void getdata() async {
    try {
      ...
      //get selected currency from sharedpreference
      _checkSelected(data);
